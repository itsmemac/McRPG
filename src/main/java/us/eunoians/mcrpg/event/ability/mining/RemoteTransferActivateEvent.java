...
public class RemoteTransferActivateEvent extends AbilityActivateEvent implements Cancellable {
    ...
    private static final Ability REMOTE_TRANSFER = McRPG.getInstance().registryAccess().registry(McRPGRegistryKey.ABILITY).getRegisteredAbility(RemoteTransfer.REMOTE_TRANSFER_KEY);
